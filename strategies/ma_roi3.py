...
class ma_roi3(IStrategy):
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[:, 'mybuy'] = dataframe['mybuy7']
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # 空头排列
        dataframe.loc[:, 'mysell'] = dataframe['full_sell_sequeue'] & (abs(dataframe['cs_ema']) > 1.0)
        ...
        dataframe.loc[:, 'mysell'] = (dataframe['mysell4'])
